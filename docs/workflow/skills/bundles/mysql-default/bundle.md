...
- engine: `mysql`
- purpose: default skill profile for MySQL database configuration optimization in workflow v1

## Skill Mapping

- Investigation skill: `mysql-investigation@1.0.0`
- Diagnosis skill: `mysql-diagnosis@1.0.0`
...
- Required evidence is defined only in `mysql-investigation`.
- Recommendation shape, confidence semantics, and citation obligations are defined only in `mysql-diagnosis`.
